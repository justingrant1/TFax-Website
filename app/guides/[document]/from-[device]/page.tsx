...
export default async function DocDevicePage({ params }: Props) {
  ...
  // Step 1: Download (always)
  // Step 2: Device-specific scan OR upload
  // Step 3: Document-specific prep
  // Step 4: Cover page (if sensitive)
  // Step 5: Enter number + send
  ...
  // ─── Build combined FAQs (2 doc-specific + 2 device-specific) ─────────────
  const faqs = [
    {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        {/* Device-specific feature callout */}
        {device.hasLiDAR && (
        ...
        {/* Device-specific camera tips (non-LiDAR) */}
