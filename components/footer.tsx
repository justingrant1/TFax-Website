      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* App Store badge */}
            <SmartAppLink className="inline-flex w-fit items-center gap-2 rounded-lg bg-foreground px-4 py-2 text-sm font-medium text-background transition-opacity hover:opacity-80">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3 text-sm" aria-label="Product navigation">
              ...
              <SmartAppLink className="text-muted-foreground transition-colors hover:text-foreground">
                Download
              </SmartAppLink>
            </nav>
          </div>
